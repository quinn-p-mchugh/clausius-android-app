...
public class SatTable extends CSVFile {
        ...
        try {
            ...
            try {
                ...
                while ((line = reader.readLine()) != null) {
                    Double[] rowValues = toDoubleArray(line.split(","));  // Converts array of String values read from CSV file to an array of Doubles

                    SatState state = new SatState();

                    /* Find each thermodynamic property value in the row using the CSV file's column headers and add each value as a property of the newly-defined state */
     ...
     *
     * @param temperature The specified temperature [°C]
     ...
     *_
     * @param T The temperature determined from the user's touch [°C]
     ...
     *_
     * @param T The temperature at the location of the user's touch [°C]
     * @param x The quality at the location of the user's touch [between 0 and 1]
     ...
     *_
     * @param T The temperature at the location of the user's touch [°C]
     * @param s The entropy at the location of the user's touch [kJ/kg/K]
     * @return The calculated quality [between 0 and 1]
     */
