...
- [X] Write this README
- [X] Resolve edge cases with temperature-entropy chart
...
## Credits
Special thanks to [Dr. Smitesh Bakrania](http://users.rowan.edu/~bakrania/PersonalPage/Smitesh_Bakrania,_Ph.D..html) for coming up with the idea for this app and providing the thermodynamic property data necessary for implementing the app's basic functionality.
